...
trait HasPushSubscriptions
{
     ...
     *
     * @return \DoctrineWeb\WebPush\PushSubscription
     */
    public function pushSubscriptions()
    {
        //return $this->morphMany(config('doctrinewebpush.model'), 'subscribable');
        return $this->belongsTo(config('doctrinewebpush.model'));
    }
    ...
    {
        $subscription = app(config('doctrinewebpush.model'))->findByEndpoint($endpoint);
